...
// Creates a connection to the SQLite database file specified in SQLITE_FILE_NAME
const db = new sqlite3.Database("./" + SQLITE_FILE_NAME, function(err)
{
    if (err)
    {
    ...
    console.log(`Connected to the '${SQLITE_FILE_NAME}' SQLite database.`);
});
